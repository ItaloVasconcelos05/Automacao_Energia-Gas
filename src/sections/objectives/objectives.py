...
def gerar_secao_objetivos(doc: Document):
    ...
    from utils import adicionar_paragrafo_bullet_bold
    for titulo, texto in objetivos:
        adicionar_paragrafo_bullet_bold(doc, titulo, texto, tamanho_fonte=12, alinhamento=WD_ALIGN_PARAGRAPH.JUSTIFY)
